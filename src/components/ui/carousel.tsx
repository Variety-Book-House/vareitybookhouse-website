...
function CarouselPrevious({
  ...
  return (
    <Button
      ...
      onClick={scrollPrev}
    >
      <span className="text-white hover:opacity-80 text-4xl font-bold pointer-events-none">&lt;</span>

      {/* Radial gradient starting from center */}
      <span
        className="absolute inset-0 pointer-events-none transition-opacity duration-600 group-hover:opacity-60"
        style={{
          background: "radial-gradient(circle at center, rgba(0,0,0,0.25) 4%, rgba(0,0,0,0) 70%)",
        }}
      />
    </Button>
